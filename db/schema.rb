...
ActiveRecord::Schema.define(version: 2021_12_07_091545) do
  ...
  create_table "counts", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["thought_id"], name: "index_counts_on_thought_id"
  ...
  create_table "thought_tags", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["tag_id"], name: "index_thought_tags_on_tag_id"
    t.index ["thought_id"], name: "index_thought_tags_on_thought_id"
  end
  ...
  add_foreign_key "counts", "thoughts"
